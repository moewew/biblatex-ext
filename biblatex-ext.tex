...
\newrobustcmd*{\titlelink}{\hyper@normalise\ltd@titlelink}
\def\ltd@titlelink#1{\url{#1}}
...
\renewrobustcmd*{\printtitlepage}{%
  ...
  \raggedleft
    ...
    \expandafter\titlelink\expandafter{\ltd@title@link}\par
  \raggedright
...
\item[bibnamehash] Replace recurring name lists with a dash.
                   Compare name lists using \bibfield{bibnamehash}, taking
