...
\newrobustcmd*{\bibfieldformat}[1]{\textsf{#1}}
...
This style bundle is available on \mkbibacro{CTAN}.%
...
\keyitem[bib(list)labeldate] The format for the labeldate in the bibliography or
...
\keyitem[issuedate] The format of the \bibfield{issue} and \bibfield{date}
...
\keyitem[volumeof] The format for the \bibfield{volume} of a \bibfield{maintitle}
...
\keyitem[titlecase:title] The standard styles follow an all-or-nothing approach
  when it comes to title casing. The field format \bibfieldformat{titlecase}
  intended to enable sentence case with \cmd{MakeSentenceCase*} is applied to
  all title-like fields alike. Finer control over the title casing of each field
  could require involved code.\fnurl{https://tex.stackexchange.com/a/22981/}
...
\keyitem[titlecase:booktitle] Like \bibfieldformat{titlecase:title}, but
  controls the title casing of the \bibfield{booktitle} and
  \bibfield{booksubtitle} fields.

\keyitem[titlecase:maintitle] Like \bibfieldformat{titlecase:title}, but
  controls the title casing of the \bibfield{maintitle} and
  \bibfield{mainsubtitle} fields.

\keyitem[titlecase:journaltitle] Like \bibfieldformat{titlecase:title}, but
  controls the title casing of the \bibfield{journaltitle} and
  \bibfield{journalsubtitle} fields.

\keyitem[titlecase:issuetitle] Like \bibfieldformat{titlecase:title}, but
  controls the title casing of the \bibfield{issuetitle} and
...
\item Add \bibfield{titlecase:...title} field formats\see{sec:opt:field}
