...
\end{ltxsyntax}
\begin{bibexample}
\renewcommand*{\extradateonlycompcitedelim}{\highlight{\textbf{\addcomma}}}
\cite{knuth:ct:b,knuth:ct:c}
\end{bibexample}


\section{Delimiters for Citation Commands}
...
\section{Selected Bibliography Macros}
\begin{keymarglistbook}
\item[edition]
...
\bibfield{volumes} fields for \bibtype{book}- and \bibtype{inbook}-like
entry types.
\end{keymarglistbook}
...
crazyhair=magenta!60!violet,
cape,
book=\scalebox{.5}{Bib\LaTeX},
bookcolour=spot]
\end{tikzpicture}
\end{center}
