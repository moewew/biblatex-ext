...
\bibfieldformatitem{bib(list)labeldate} The format for the labeldate in the
  bibliography or
...
\begin{bibexample}
\togglefalse{bbx:doi}
\renewcommand*{\jourserdelim}{\highlightbf{\addperiod}%
                              \highlight{\textvisiblespace}%
                              \bibsentence% <- hacky ...
                              }% <- hard-coded!
\makeatletter\bbx@opt@mergedate@false\makeatother
...
\item Add \bibfieldformat{titlecase:\dots title} field formats\see{sec:opt:field}
