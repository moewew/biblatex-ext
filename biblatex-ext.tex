...
The package needs to be loaded after \sty{biblatex} and has no further options.
\begin{biblatexcode}
...
right it may be split off from the rest of this bundle in the future.
In that case the name \sty{biblatex-ext-tabular} may be deprecated in favour
of something more snappy.
The old name should continue to work, but you may have to install a new package
for it to work.
...
Before tabular bibliographies can be used, a suitable definition must be
supplied with \cmd{defbibtabular}.
...
\begin{bibexample}
  ...
  \exampleprintbibtab{sigfridsson,worman,geer,nussbaum}
\end{bibexample}
...
\item New styles \sty{ext-authoryear-ecomp} and \sty{ext-authoryear-iecomp}%
  \see{sec:styles:new}
